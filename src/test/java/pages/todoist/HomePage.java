...
{
    public Button homeButton = new Button(By.xpath("//button[@class=\"top_bar_btn home_btn\"]") , "[Home] button on Home page");
    public Button verifyEmailButton = new Button(By.xpath("(//div[@data-testid=\"toaster\"]/div/div/div)[last()]/button"), "[Close Verify email Pop-up] button on Home page");
    ...
    public Button addProjectButton = new Button(By.xpath("//button[@class=\"a8af2163 _98cd5c3f _45ffe137 ef4c88db f9408a0e\"]"), "[Add project] button on the Home page Left Side");
    ...
    {
        Label registeredEmail = new Label(By.xpath("//p[@class='user_menu_email' and text() = '" +email+ "']"), "["+email+"] email label on [Profile settings] menu");

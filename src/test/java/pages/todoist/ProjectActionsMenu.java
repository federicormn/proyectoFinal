...
public class ProjectActionsMenu
{
    ...
    public Button addToFavoritesButton = new Button(By.xpath("//div[@class=\"icon_menu_item__content\" and contains(text(),'Fav')]"),"[Add to favorites] button on More Project Actions menu");
